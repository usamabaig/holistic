...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.subCatagory.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.sub-catagories.update", [$subCatagory->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
