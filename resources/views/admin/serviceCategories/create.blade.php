        ...
        <form action="{{ route("admin.service-categories.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('banner_image') ? 'has-error' : '' }}">
                ...
                <p class="helper-block">
                    {{--{{ trans('cruds.service.fields.banner_image_helper') }}--}}
                    Pick banner image
                </p>
            </div>
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <input type="text" id="name" name="name" class="form-control" value="{{ old('name', isset($serviceCategory) ? $serviceCategory->name : '') }}" required>
                @if($errors->has('name'))
                    <p class="help-block">
                        {{ $errors->first('name') }}
                    </p>
            ...
            <div class="form-group {{ $errors->has('how_it_work') ? 'has-error' : '' }}">
                <label for="how_it_work">How it Work Description</label>
...
<script>
    ...
    init: function () {
@if(isset($category) && $category->category_picture)
      var file = {!! json_encode($category->category_picture) !!}
          this.options.addedfile.call(this, file)
      this.options.thumbnail.call(this, file, '{{ $category->category_picture->getUrl('thumb') }}')
      file.previewElement.classList.add('dz-complete')
